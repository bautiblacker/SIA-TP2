...
public class StructureCriteria implements StopCriteria {
    ...
    public boolean evaluate(CriteriaHandler handler) {
        ...
        System.out.println("actual porcentage --> " + proportionLimit);
        System.out.println("comparable porcentage --> " + percentage);
        System.out.println("counter --> " + handler.getCriteriaCounter());
